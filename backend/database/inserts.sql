...
-- Insert Players
CALL InsertPlayer('alice@example.com', 'Alice', 'Smith', 'Ali', 'password123', 'player', 1);
CALL InsertPlayer('bob@example.com', 'Bob', 'Brown', 'Bobby', 'password123', 'player', 1);
CALL InsertPlayer('carol@example.com', 'Carol', 'Johnson', 'CJ', 'password123', 'organizer', NULL);
CALL InsertPlayer('dave@example.com', 'Dave', 'Williams', 'D', 'password123', 'player', 2);
CALL InsertPlayer('eve@example.com', 'Eve', 'Davis', 'Evie', 'password123', 'admin', NULL);
