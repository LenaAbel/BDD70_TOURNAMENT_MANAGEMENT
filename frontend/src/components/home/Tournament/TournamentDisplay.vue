<template>
    <div class="tournament-profile">
        <b-container class="mt-5 pt-5">
            <h2 class="text-center mb-4">Tournament Profile</h2>
...
export default {
    ...
    computed: {
        ...
        tournament() {
            // Get the tournament by ID (passed via the route parameter)
            return this.allTournaments.find((tournament) => tournament.tournament_id === parseInt(this.tournamentId));
        },
        isLoading() {
            return this.loading;
        },
